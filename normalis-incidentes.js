...
function saveIncidente() {
  ...
  const severidad = document.getElementById('inc-severidad').value;
  const desc = document.getElementById('inc-desc').value;
  const accion = document.getElementById('inc-accion').value;
  const responsable = document.getElementById('inc-responsable').value;
...
function renderIncidentes() {
  ...
  const sevColor = { critico:'#ef4444', moderado:'#f59e0b', leve:'#3b82f6' };
  const sevLabel = { critico:'🔴 Crítico', moderado:'🟡 Moderado', leve:'🔵 Leve' };
