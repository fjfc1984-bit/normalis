 ...
 * Measurement ID: Reemplaza G-XXXXXXXXXX con tu ID de GA4
 * Setup: analytics.google.com → Admin → Create Property → Web → normalis.co
 *
...
(function() {
  ...
  const GA_ID = 'G-XXXXXXXXXX'; // ← Reemplaza con tu Measurement ID
