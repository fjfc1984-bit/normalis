...
<div class="doc-header-meta">${est}${nit?' · NIT '+nit:''} · ${ciudad}<br>Director Técnico: ${dir}${rm?' · '+rm:''}<br>Versión 1.0 · Fecha: ${hoy}<br><em>Elaborado conforme a Res. 1732/2026 / Res. 3100/2019 (Est. 5) · Decreto 351/2014 · Res. 1138/2022</em></div>
...
<p>Aplica a todo el personal asistencial, administrativo, de apoyo y visitantes del establecimiento, en concordancia con la Resolución 1732 de 2026 / Res. 3100/2019 (Estándar 5 — Procesos Prioritarios) y el Decreto 351 de 2014.</p>
<h2>2. MARCO NORMATIVO</h2>
<ul>
  <li>Resolución 1732 de 2026 (vigente) / Res. 3100 de 2019 — Manual de Habilitación · Estándar 5 (Procesos Prioritarios)</li>
...
<div class="doc-header-meta">${est}${nit?' · NIT '+nit:''} · ${ciudad}<br>Director Técnico: ${dir}${rm?' · '+rm:''} · Especialidad: ${esp}<br>Versión 1.0 · ${hoy}<br><em>Conforme a Res. 1732/2026 / Res. 3100/2019 (Est. 5) · Res. 13437/1991 · Res. 256/2016</em></div>
<h2>1. OBJETIVO</h2>
<p>Establecer el flujo de atención, los derechos y deberes del paciente, y los procedimientos que garanticen una atención segura, oportuna y humanizada en <strong>${est}</strong>, en cumplimiento del Estándar 5 de Procesos Prioritarios de la Resolución 1732 de 2026 (Res. 3100 de 2019).</p>
...
<div class="doc-header-meta">${est}${nit?' · NIT '+nit:''} · ${ciudad}<br>Director Técnico: ${dir}${rm?' · '+rm:''}<br>Versión 1.0 · ${hoy}<br><em>Conforme a Res. 1732/2026 / Res. 3100/2019 (Est. 5) · Res. 0312/2019</em></div>
<h2>1. PROPÓSITO</h2>
...
<div class="doc-header-meta">${est}${nit?' · NIT '+nit:''} · ${ciudad}<br>Director Técnico: ${dir}${rm?' · '+rm:''}<br>Versión 1.0 · ${hoy}<br><em>Conforme a Decreto 4725/2005 · Res. 1732/2026 / Res. 3100/2019 Estándar 3 · Res. 1138/2022</em></div>
<h2>1. OBJETIVO</h2>
...
<p>Queda estrictamente prohibida la reutilización de dispositivos médicos rotulados como de uso único, conforme al Estándar 3 de la Resolución 1732 de 2026 / Res. 3100 de 2019 y la Res. 1138 de 2022. El personal debe verificar el rotulado antes de cada procedimiento.</p>
<div class="sign-block">
  <div><div class="sign-line"><strong>${dir}</strong><br>Director Técnico${rm?' · '+rm:''}<br>${est}</div></div>
...
<div class="doc-header-meta">${est}${nit?' · NIT '+nit:''}<br>Conforme a Decreto 4725/2005 · Res. 1732/2026 / Res. 3100/2019 Estándar 3</div>
...
function buildStreamLines(){
  ...
  return [
    ...
    '> Aplicando Resolución 1732 de 2026 (Estándares 3, 5, 6)…',
