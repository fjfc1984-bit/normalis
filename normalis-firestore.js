...
function xaiResponder(pregunta) {
  ...
  if (q.indexOf('visit')>=0 || q.indexOf('secret')>=0 || q.indexOf('habilitac')>=0 || q.indexOf('prepar')>=0 || q.indexOf('listo')>=0 || q.indexOf('lista')>=0) {
    ...
    if (problemas.length === 0) {
      ...
      resp += '<div style="font-size:11px;color:#64748b;margin-bottom:10px">Normativa: Res. 3100/2019 / Res. 1732/2026 - Res. 465/2025 - Ley 1438/2011</div>';
...
function renderROI() {
  let SMLMV = 1300000;
  let html = '<div style="padding:24px;max-width:960px;margin:0 auto">';
  html += '<div style="margin-bottom:24px"><h2 style="margin:0 0 4px;font-size:22px;font-weight:800">Calculadora de ROI</h2><p style="margin:0;color:#64748b;font-size:13px">Cuanto cuesta NO tener NormaLis — basado en sanciones reales Ley 1438/2011, Res. 3100/2019 y Res. 1732/2026</p></div>';
