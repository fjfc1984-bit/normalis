...
,
  ...
  farmacia:[
    ...
    {id:'far-dotacion',icon:'🔬',name:'Dotación y Tecnología',norm:'Res. 1403/2007 · Decreto 780/2016 · Buenas prácticas farmacéuticas',q:[
    ...
    {id:'far-procesos',icon:'📋',name:'Procesos — Dispensación y Farmacovigilancia',norm:'Res. 1403/2007 · INVIMA · Farmacovigilancia · Res. 2003/2014',q:[
...
function selSeg(seg){
  segActivo=seg;
  areas=areasDB[seg];
  ['general', 'domiciliaria', 'imagenologia', 'calidad', 'urgencias', 'internacion', 'quirurgicos', 'laboratorio', 'transporte', 'rehabilitacion', 'salud_mental', 'odontologia', 'consulta_externa', 'cuidado_intensivo', 'obstetricia', 'banco_sangre', 'oncologia', 'hemodialisis', 'farmacia', 'vacunacion', 'telemedicina', 'esterilizacion', 'trasplante'].forEach(s=>{
