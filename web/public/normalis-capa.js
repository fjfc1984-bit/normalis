...
(function() {
  ...
  // ── Exports ──────────────────────────────
  window.renderCAPAs               = renderCAPAs;
  window.abrirCAPAModal            = abrirCAPAModal;
  window.cerrarCAPAModal           = cerrarCAPAModal;
  window.crearCAPADesdeNC          = crearCAPADesdeNC;
  window.saveCAPA                  = saveCAPA;
  window.iniciarCAPA               = iniciarCAPA;
  window.cerrarCAPA                = cerrarCAPA;
  window.exportarPlanMejoramientoPDF = exportarPlanMejoramientoPDF;
})();
