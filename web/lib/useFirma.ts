...
export const FIRMA_CATALOGO = [
  {
    ...
    base:   'Res. 1732/2026 Est. 2 · Decreto 1072/2015',
    icono:  '🛡️',
  },
  {
    id:     'atencion',
    nombre: 'Protocolo de Atención al Paciente',
    base:   'Res. 1732/2026 Est. 5 — Procesos Prioritarios',
    icono:  '📋',
  },
  {
    id:     'residuos',
    nombre: 'Plan de Gestión de Residuos (PGIRASA)',
    base:   'Res. 591/2024 (PGIRASA) · Res. 1732/2026 Est. 2',
    icono:  '♻️',
  },
  {
    id:     'tecnovigilancia',
    nombre: 'Manual de Tecnovigilancia',
    base:   'Res. 4816/2008 · Res. 1732/2026 Est. 3',
    icono:  '🔬',
  },
  {
    id:     'emergencias',
    nombre: 'Plan de Emergencias y Desastres',
    base:   'Res. 1732/2026 Est. 2 · UNGRD',
    icono:  '🚨',
  },
  {
    id:     'medicamentos',
    nombre: 'Protocolo de Manejo de Medicamentos',
    base:   'Res. 1732/2026 Est. Medicamentos, Dispositivos, Insumos y Otras Tecnologías',
    icono:  '💊',
  },
  {
    id:     'habilitacion',
    nombre: 'Auto-declaración de Habilitación',
    base:   'Res. 1732/2026 — Formulario de Inscripción de Prestadores (reemplaza Res. 3100/2019 Art. 6)',
    icono:  '🏥',
  },
  {
    id:     'calidad',
    nombre: 'Manual del Sistema de Gestión de Calidad',
    base:   'Res. 1446/2006 · Res. 256/2016 (mod. Res. 3539/2019) · PAMEC',
    icono:  '⭐',
  },
] as const;
