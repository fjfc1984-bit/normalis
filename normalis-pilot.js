...
(function () {
  ...
  style.textContent = ''
    ...
    + '  background:linear-gradient(135deg,#071920,#0d2d3a);'
    ...
    + '#nls-pilot-expired p{font-size:14px;color:#7fb5aa;max-width:400px;line-height:1.65;margin-bottom:26px;}'
    ...
    + '  box-shadow:0 4px 20px rgba(0,201,167,.28);display:inline-block;'
    + '}'
    + '#nls-pilot-expired .npe-back{'
    + '  display:inline-block;margin-top:12px;'
    + '  background:transparent;border:1px solid rgba(255,255,255,.15);'
    + '  color:#7fb5aa;border-radius:12px;padding:10px 24px;'
